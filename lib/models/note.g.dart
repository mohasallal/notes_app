...
void _noteSerialize(
  ...
  writer.writeBool(offsets[1], object.isFav);
...
Note _noteDeserialize(
  ...
  object.id = id;
  object.isFav = reader.readBool(offsets[1]);
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> isFavEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isFav',
        value: value,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'subject',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'subject',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'subject',
        value: '',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subjectIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'subject',
        value: '',
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortByIsFav() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFav', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByIsFavDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByIsFav() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFav', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByIsFavDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFav', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctByIsFav() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, bool, QQueryOperations> isFavProperty() {
    return QueryBuilder.apply(this, (query) {
